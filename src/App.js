    ...
    return  (
      ...
      <div className="row justify-content-around">
        ...
        <img src="/img/scalingnow.svg" className="typelogo"/>
          ...
          <p><strong>March 5th</strong> is an invite-only event for select devs working on immediate scaling solutions to share their insights amongst one another.</p>
          <p><strong>March 6th</strong> is open to DApp developers who submit a (super quick and easy) <a href="https://docs.google.com/forms/d/1tMq8AamiQ2PI0zulo_jxIV4Ef9h0D9DjrgjfSK70I0M/viewform?edit_requested=true">form</a> as requested in the form each attendee must donate from a unique address so that we can count how many Tapas we need.</p>
          <p>We encourage you to open your wallets and let the donations flow through. Your donation covers the costs of venue rentals and food expenses. </p>
          <p>We aren’t trying to force some cellophane wrapped sad-wiches on you - this is Barcelona, we’ve already found the best Tapas and Cava joints so we can collaborate over real Catalan culture.</p>
        ...
        <div className="col donationColumn">
          ...
          <h4>1. Publicly: Send a transaction via Metamask with your Team Name in the Remarks </h4>
